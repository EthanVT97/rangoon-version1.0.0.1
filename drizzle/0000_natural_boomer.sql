...
-- Table: api_logs (with foreign key to staging_erpnext_imports)
CREATE TABLE "api_logs" (
    ...
    "created_at" timestamp DEFAULT now() NOT NULL,
    CONSTRAINT "fk_api_logs_staging" FOREIGN KEY ("staging_id")
        REFERENCES "staging_erpnext_imports"("id")
        ON DELETE SET NULL
);
